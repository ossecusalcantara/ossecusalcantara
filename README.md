...
*   **♙ O Tabuleiro:** `Arch Linux` | `Neovim` | `Docker` | `Git`

## ♛ Interesses e Estudos Atuais

*   `[e2-e4]` Web3, Blockchain e Criptografia
*   `[d2-d4]` Desenvolvimento de Sistemas Operacionais e Kernel
*   `[Ng1-f3]` Sistemas Embarcados e Microcontroladores (ESP32)
